										...
										<div class="row w-100" style="margin-bottom: 3px">
											<div class="col-md-3">
												<select class="form-control" id="selector" style="border: 1px solid #dddd" name="">
													<option id="all" value="statecont" active>Semua (Default)</option>
													<option id="ongoing" value="ongoing">Sedang Berjalan</option>
													<option id="done" value="done">Telah Selesai</option>
												</select>
											</div>
											<div class="col-md-6">
