		...
		<div class="col-xs-12">
			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-pencil-square"></i>Uraian Pelanggan TM
					</div>
					<div class="tools">
						...
						<div class="tabbable tabbable-custom">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1_1">
									<!-- BEGIN FORM-->
									<?php echo form_open_multipart('pelanggan_TM/uploaddata','class="form-horizontal"');?>
									<div class="form-body">
										<br>
										<?php
										foreach($hasil as $listhasil):
										...
										<tbody>
											...
											foreach($hasil as $listhasil):
												foreach($upload as $datahasil):
													...
													echo "<td><a href='".base_url()."assets/data_upload/PelangganTM/".$listhasil->NAMA_PEL."/".$datahasil->DATA_UPLOAD."'>".$datahasil->DATA_UPLOAD."</a></td>";
													echo "</tr>";
													$i++;
												endforeach;
											endforeach;	
			...
			<?php echo form_open('pelanggan_TM/dataupdate','class="form-horizontal"');?>
				...
				<div class="form-body">
					<table class="table table-striped table-hover table-bordered display" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
								<td>Tgl Kirim NODIN ke PP dari REN</td>
								<td>
									<div class="input-group input-large date date-picker" data-date-format="yyyy-mm-dd" >
										<span class="input-group-btn">
											<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
							...
							<tr>
								...
								<td>
									<div class="input-group input-large">
										...
										<select class="form-control" name="c2" id="select" <?php echo $array_status[17];?>>
							...
							<tr>
								<td>Tgl Kirim NODIN kirim NODIN(PK) ke KON dari REN </td>
								<td>
									<div class="input-group input-large date date-picker" data-date-format="yyyy-mm-dd" >
										<span class="input-group-btn">
											<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
							...
							<tr>
								...
								<td>
									<div class="input-group input-large">
										...
										<input name="f2" class="form-control" type="text" value="<?php echo $listhasil->KET_ANGKA?>" <?php echo $array_status[20];?>>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="input-group input-large">
										...
										<input name="g2" class="form-control" type="text" value="<?php echo $listhasil->KET_URAIAN?>" <?php echo $array_status[21];?>>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<div class="input-group input-large">
										...
										<input name="i2" class="form-control" type="text" value="<?php echo $listhasil->NO_WO_TIANG?>" <?php echo $array_status[23];?>>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="input-group input-large">
										...
										<input name="j2" class="form-control" type="text" value="<?php echo $listhasil->NAMA_PABRIKAN_WO_TIANG?>" <?php echo $array_status[24];?>>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="input-group input-large">
										...
										<input name="k2" class="form-control" type="text" value="<?php echo $listhasil->TGL_WO_TIANG?>" <?php echo $array_status[25];?>>
									</div>
								</td>
							</tr>
						</tbody>
							...
							<tr>
								...
								<td>
									<div class="input-group input-large date date-picker" data-date-format="yyyy-mm-dd" >
										...
										<input name="d3" class="form-control" type="text" value="<?php echo $listhasil->TGL_OPERASI?>" <?php echo $array_status[29];?>>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="input-group input-large">
										...
										<input name="e3" class="form-control" type="text" value="<?php echo $listhasil->KON_A3CS?>" <?php echo $array_status[30];?>>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="input-group input-large">
										...
										<input name="f3" class="form-control" type="text" value="<?php echo $listhasil->PIN_ISOLATOR?>" <?php echo $array_status[31];?>>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td><div class="input-group input-large">
									...
									<input name="g3" class="form-control" type="text" value="<?php echo $listhasil->HANG_ISOLATOR?>" <?php echo $array_status[32];?>>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group input-large">
									...
									<input name="h3" class="form-control" type="text" value="<?php echo $listhasil->KON_CUBICLE?>" <?php echo $array_status[33];?>>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group input-large">
									...
									<input name="i3" class="form-control" type="text" value="<?php echo $listhasil->KON_TRAFO?>" <?php echo $array_status[34];?>>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group input-large">
									...
									<input name="j3" class="form-control" type="text" value="<?php echo $listhasil->KON_LVPANEL?>" <?php echo $array_status[35];?>>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group input-large">
									...
									<input name="k3" class="form-control" type="text" value="<?php echo $listhasil->KON_SKTM?>" <?php echo $array_status[36];?>>
								</div>
							</td>
						</tr>
						<tr>
