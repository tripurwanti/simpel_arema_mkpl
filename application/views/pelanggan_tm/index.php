										...
										<div class="row w-100" style="margin-bottom: 3px">
											...
											<div class="col-md-6">
												<div class="btn-group pull-right">
													<a class="btn blue" href="<?php echo base_url()?>pelanggan_TM/exporttoexcel">
													Export to Excel </a>
												</div>
											</div>
										</div>
					...
					<div class="modal-body">
						<form method="POST" action="<?php echo base_url()?>pelanggan_TM/saveaddlokasi" class="form-horizontal" role="form">
							<table class="table table-striped table-hover display" width="100%">
								...
								<tr>
									<td>Daya Baru</td>
									<td><input name="i" class="form-control input-large" type="text" required></td>
									<td>Jenis Transaksi</td>
									<td>
										<select class="form-control" name="j" id="select" required>
								...
								<tr>
									<td colspan="4"><font color="red">** Nama Pelanggan, Alamat, Daya baru, Jenis transaksi, dan Nama Rayon Harus Diisi</font></td>
								</tr>
							</table>
						</div>
