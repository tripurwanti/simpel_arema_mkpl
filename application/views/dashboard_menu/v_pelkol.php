...
<div class="page-content">
	<div class="row">
		<div class="col-md-12">
			...
			<h3 class="page-title">
				Pelanggan Kolektif <small class="font-red">(<?php echo $sub_title ?>)</small>
			</h3>
		...
		<div class="col-xs-12">	     
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-edit"></i>Pelanggan Kolektif
					</div>
					<div class="tools">
						...
						<div class="row">
							...
							<div class="col-md-6" align="center">
								<div class="btn-group pull-center">
									<table>
										<tr>
											<?php echo form_open('kolektif/'.$link.'/filter/'.$code); ?>
											<td>
					...
					<div class="modal-body">
						<form method="POST" action="<?php echo base_url()?>kolektif/saveaddlokasi" class="form-horizontal" role="form">
							<table class="table table-striped table-hover display" width="100%">
								...
								<tr>
									<td colspan="4"><font color="red">* Nama Pemohon dan Nama Pelanggan Harus Diisi</font></td>
								</tr>
							</table>
						</div>
